...
# 1. Add UI
ui_addition = """
        <div class="field full" style="background:var(--bg); border:1px solid var(--border); padding:15px; border-radius:12px; margin-top:10px; margin-bottom:15px;">
...
"""
admin = admin.replace('function openModal(p) {', js_addition + '\nfunction openModal(p) {')
...
print("UI successfully injected in admin.php")
